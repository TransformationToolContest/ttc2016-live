 ...
 * <ul>
 *   <li>{@link eu.ttc.dataflow.model.dataflow.impl.ElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.ttc.dataflow.model.dataflow.impl.ElementImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ElementImpl extends MinimalEObjectImpl.Container implements Element
{
	...
	{
		return DataflowPackage.Literals.ELEMENT;
	}
	...
	public Element getTarget()
	{
		if (target != null && target.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataflowPackage.ELEMENT__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Element newTarget)
	{
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataflowPackage.ELEMENT__TARGET, oldTarget, target));
	}
