...
namespace TTC2016.LiveContest.Dataflow
{
    ...
    /// <summary>
    /// The public interface for NewContainer
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(NewContainer))]
    [XmlDefaultImplementationTypeAttribute(typeof(NewContainer))]
    public interface INewContainer : IModelElement, IElement
    {
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ContainerTypeChanging;
        
        /// <summary>
        /// Gets fired when the ContainerType property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ContainerTypeChanged;
    }
}
