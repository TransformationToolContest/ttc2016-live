...
namespace TTC2016.LiveContest.Dataflow
{
    ...
    /// <summary>
    /// The default implementation of the RealLiteral class
    /// </summary>
    [XmlNamespaceAttribute("http://transformation-tool-contest.eu/2016/dataflow")]
    [XmlNamespacePrefixAttribute("df")]
    [ModelRepresentationClassAttribute("http://transformation-tool-contest.eu/2016/dataflow#//RealLiteral/")]
    public class RealLiteral : Expression, IRealLiteral, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://transformation-tool-contest.eu/2016/dataflow#//RealLiteral/");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://transformation-tool-contest.eu/2016/dataflow#//RealLiteral/")));
        }
        
        /// <summary>
        /// Represents a proxy to represent an incremental access to the value property
        /// </summary>
        private sealed class ValueProxy : ModelPropertyChange<IRealLiteral, Nullable<double>>
        {
            ...
            public ValueProxy(IRealLiteral modelElement) : 
                    base(modelElement)
            {
            }
