...
namespace TTC2016.LiveContest.Dataflow
{
    ...
    /// <summary>
    /// The default implementation of the NewContainer class
    /// </summary>
    [XmlNamespaceAttribute("http://transformation-tool-contest.eu/2016/dataflow")]
    [XmlNamespacePrefixAttribute("df")]
    [ModelRepresentationClassAttribute("http://transformation-tool-contest.eu/2016/dataflow#//NewContainer/")]
    [DebuggerDisplayAttribute("NewContainer {Name}")]
    public class NewContainer : Element, INewContainer, IModelElement
    {
        ...
        /// <summary>
        /// The backing field for the ContainerType property
        /// </summary>
        ...
        /// </summary>
        [XmlElementNameAttribute("containerType")]
        [XmlAttributeAttribute(true)]
        public virtual Nullable<ContainerType> ContainerType
        {
            get
            {
        ...
        /// <summary>
        /// Raises the ContainerTypeChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        ...
        /// </summary>
        private sealed class ListFieldProxy : ModelPropertyChange<INewContainer, string>
        {
            ...
            public ListFieldProxy(INewContainer modelElement) : 
                    base(modelElement)
            {
            }
        ...
        /// <summary>
        /// Represents a proxy to represent an incremental access to the containerType property
        /// </summary>
        private sealed class ContainerTypeProxy : ModelPropertyChange<INewContainer, Nullable<ContainerType>>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public ContainerTypeProxy(INewContainer modelElement) : 
                    base(modelElement)
            {
            }
            ...
            /// Gets or sets the value of this expression
            /// </summary>
            public override Nullable<ContainerType> Value
            {
                get
                {
                    return this.ModelElement.ContainerType;
                }
                set
                {
                    this.ModelElement.ContainerType = value;
                }
            }
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.ContainerTypeChanged += handler;
            }
