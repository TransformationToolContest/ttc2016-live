...
/**
 * This is the item provider adapter for a {@link dataflow.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataflowPackage.Literals.ELEMENT__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_target_feature", "_UI_Element_type"),
				 DataflowPackage.Literals.ELEMENT__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Element)object).getDescription();
