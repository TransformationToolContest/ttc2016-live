...
/**
 * This is the item provider adapter for a {@link eu.ttc.dataflow.model.launchConfiguration.Dataflow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataflowItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dataflow_location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dataflow_location_feature", "_UI_Dataflow_type"),
				 LaunchConfigPackage.Literals.DATAFLOW__LOCATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Dataflow)object).getLocation();
