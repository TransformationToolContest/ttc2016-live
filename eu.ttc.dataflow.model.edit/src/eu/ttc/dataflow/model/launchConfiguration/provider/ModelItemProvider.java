/**
 */
package eu.ttc.dataflow.model.launchConfiguration.provider;
...
/**
 * This is the item provider adapter for a {@link eu.ttc.dataflow.model.launchConfiguration.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LaunchConfigPackage.Literals.MODEL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Model_location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Model_location_feature", "_UI_Model_type"),
				 LaunchConfigPackage.Literals.MODEL__LOCATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addReadOnLoadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Model_readOnLoad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Model_readOnLoad_feature", "_UI_Model_type"),
				 LaunchConfigPackage.Literals.MODEL__READ_ON_LOAD,
				 true,
				 false,
				 false,
	...
	protected void addStoreOnDisposalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Model_storeOnDisposal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Model_storeOnDisposal_feature", "_UI_Model_type"),
				 LaunchConfigPackage.Literals.MODEL__STORE_ON_DISPOSAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LaunchConfigPackage.Literals.MODEL__METAMODELS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LaunchConfigPackage.Literals.MODEL__METAMODELS,
				 LaunchConfigFactory.eINSTANCE.createMetamodel()));
	}
