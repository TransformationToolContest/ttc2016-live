...
/**
 * This is the item provider adapter for a {@link eu.ttc.dataflow.model.launchConfiguration.Metamodel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetamodelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Metamodel_location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Metamodel_location_feature", "_UI_Metamodel_type"),
				 LaunchConfigPackage.Literals.METAMODEL__LOCATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Metamodel)object).getLocation();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Metamodel.class)) {
			case LaunchConfigPackage.METAMODEL__LOCATION:
