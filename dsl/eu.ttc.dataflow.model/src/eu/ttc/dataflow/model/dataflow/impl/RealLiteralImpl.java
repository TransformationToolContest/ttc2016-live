 ...
 * </p>
 * <ul>
 *   <li>{@link eu.ttc.dataflow.model.dataflow.impl.RealLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RealLiteralImpl extends ExpressionImpl implements RealLiteral {
	...
	protected EClass eStaticClass() {
		return DataflowPackage.Literals.REAL_LITERAL;
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataflowPackage.REAL_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataflowPackage.REAL_LITERAL__VALUE:
				return getValue();
		}
