...
/**
 * This is the item provider adapter for a {@link eu.ttc.dataflow.model.dataflow.CollectBy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CollectByItemProvider extends ElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CollectByItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataflowPackage.Literals.COLLECT_BY__COLLECT_BY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CollectBy"));
	}
	...
	public String getText(Object object) {
		String label = ((CollectBy)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CollectBy_type") :
			getString("_UI_CollectBy_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CollectBy.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataflowPackage.Literals.COLLECT_BY__COLLECT_BY,
