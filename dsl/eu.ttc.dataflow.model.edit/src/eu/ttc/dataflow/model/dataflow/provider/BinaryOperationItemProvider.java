...
/**
 * This is the item provider adapter for a {@link eu.ttc.dataflow.model.dataflow.BinaryOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BinaryOperationItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryOperation_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryOperation_operator_feature", "_UI_BinaryOperation_type"),
				 DataflowPackage.Literals.BINARY_OPERATION__OPERATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataflowPackage.Literals.BINARY_OPERATION__LEFT_EXPRESSION);
			childrenFeatures.add(DataflowPackage.Literals.BINARY_OPERATION__RIGHT_EXPRESSION);
		}
	...
	public String getText(Object object) {
		BinaryOperator labelValue = ((BinaryOperation)object).getOperator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_BinaryOperation_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataflowPackage.Literals.BINARY_OPERATION__LEFT_EXPRESSION,
		...
		newChildDescriptors.add
			(createChildParameter
				(DataflowPackage.Literals.BINARY_OPERATION__RIGHT_EXPRESSION,
				 DataflowFactory.eINSTANCE.createIntegerLiteral()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DataflowPackage.Literals.BINARY_OPERATION__LEFT_EXPRESSION ||
			childFeature == DataflowPackage.Literals.BINARY_OPERATION__RIGHT_EXPRESSION;
